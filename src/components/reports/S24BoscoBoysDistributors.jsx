  ...
  return (
    ...
    >
      ...
      <section className="mb-14">
        ...
        <div className="bg-bgContrast mb-6 grid grid-cols-1 gap-6 rounded-md p-6 text-lg text-text shadow-md md:grid-cols-2">
      ...
      <section className="mb-14">
        ...
        <div className="bg-bgContrast mb-4 flex flex-col rounded-md p-6 text-lg shadow-md">
        ...
        <div className="bg-bgContrast mb-4 grid grid-cols-1 rounded-md p-6 shadow-md sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
          <div>
